...
---
# [init] Run an agent team to implement the implementation tickets.
...
- The openspec artifact paths for this branch (list them explicitly - the ones with plan file openspec/changes/alerter-swift-wrapper/proposal.md).
